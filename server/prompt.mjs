...
- MOTIVO DE LA CONSULTA debe ser una formulación clínica directa y muy breve del hecho/problema que motiva la valoración. No añadas etiquetas de riesgo, gravedad o diagnóstico que no formen parte explícita del motivo o no estén sustentadas por la entrevista. Ejemplo: "Autolesiones mediante cortes en miembro superior e ideación autolítica." Nunca una narración del diálogo.
- PSQ GUARDIA debe contener exactamente: "MIR MAtesanz".

REGLAS POR APARTADO
1. MOTIVO: problema clínico actual en una o varias frases nominales/directas. Evita expresiones vagas como "posible riesgo" si el riesgo concreto puede describirse después en ENFERMEDAD ACTUAL/SEGURIDAD.
