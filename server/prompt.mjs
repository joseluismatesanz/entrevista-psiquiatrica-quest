...
- Evita frases metadiscursivas o propias de una IA como "no se aportan datos sobre...", "no se documentan otros componentes...", "por su edad no procede...", "con la información disponible..." cuando simplemente basta con omitir lo no explorado o marcar evidence_status/missing_or_not_explored. El texto de sections nunca debe mencionar "la transcripción", "la evidencia", "las fuentes", "no confirmado por el modelo" ni el proceso de extracción; esas advertencias pertenecen a safety_review/missing_or_not_explored.
...
6. ANTECEDENTES FAMILIARES PSIQUIÁTRICOS: conserva antecedentes psiquiátricos de familiares aportados explícitamente por el paciente o por informantes colaterales pertinentes (madre, padre, otros familiares o cuidadores) y, cuando proceda, por historia clínica. Mantén la atribución mediante source_ids y no mezcles versiones discrepantes. Excluye amigos, vecinos, conocidos o compañeros que no sean familiares del paciente. Que un familiar mencione únicamente que toma uno o varios psicofármacos para sí mismo no permite inferir un diagnóstico o antecedente familiar: no lo incluyas en este apartado salvo que exista un diagnóstico, trastorno, seguimiento o antecedente psiquiátrico explícito. Nunca añadas al texto razonamientos como «corresponde a la madre» o «no establece antecedentes familiares»; simplemente omite el dato y ajusta evidence_status.
...
9. TRATAMIENTO HABITUAL: SOLO medicación vigente antes de la valoración, psiquiátrica y orgánica, y adherencia. Un fármaco por entidad estructurada. Si el paciente niega explícitamente tomar medicación habitual, consérvalo como dato supported (por ejemplo, "No toma medicación habitual"), no como not_provided/not_explored. Si un tratamiento se tomó en el pasado o de forma intermitente sin confirmación de vigencia actual, márcalo historical y no lo presentes como habitual activo.
10. ENFERMEDAD ACTUAL: narrativa sintética del episodio actual. La contención mecánica, desescalada, medicación intramuscular y evolución aguda pertenecen aquí cuando forman parte del episodio. Evita repetir antecedentes, medicación habitual, tóxicos estables, exploración psicopatológica y plan salvo cuando sean necesarios para entender la secuencia clínica. Una pauta prescrita para después de la valoración pertenece a PLAN TERAPÉUTICO/TRATAMIENTO ACTUAL y no debe copiarse aquí; solo conserva medicación ya administrada si forma parte del episodio agudo.
...
12. EXPLORACIÓN PSICOPATOLÓGICA: solo estado ACTUAL referido por el paciente, explorado por el psiquiatra u observado directamente por el clínico. Considera, si están sustentados: conciencia/orientación, aspecto/autocuidado, actitud/colaboración, contacto, atención/cognición/concentración, lenguaje/discurso, psicomotricidad, ánimo, afectividad, pensamiento (curso/forma y contenido), sensopercepción, autoagresividad, heteroagresividad, ideación de muerte/riesgo autolítico, sueño/apetito, juicio de realidad, insight y autocontención. Las descripciones de familiares (por ejemplo, "la madre la ve cansada") pertenecen a ENFERMEDAD ACTUAL, no a la exploración psicopatológica. Ausencia de datos NO equivale a normalidad. Si solo se exploran unos pocos dominios, informa únicamente esos dominios y marca el conjunto como insufficient cuando no permita una exploración completa. No cierres con frases como "no se documentan otros componentes"; simplemente omite lo no explorado y consígnalo en missing_or_not_explored si es relevante.
...
- Si el nombre es dudoso, conserva literalmente raw_name en el informe sin añadir frases como "principio activo no confirmado" o "no establecido en la transcripción"; registra la necesidad de revisión únicamente en safety_review.
